...
setopt prompt_subst
# PROMPT="${purple}%c%{$reset_color%} \$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${orange} λ %{$reset_color%} "
PROMPT='%{%F{245}%}[%{%F{magenta}%}%~%{%F{245}%}]$vcs_info_msg_0_%{%F{166}%  $%{%f%} '
